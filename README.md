...
- возможность горизонтального масштабирования и шардирования.
...
- [ ] веб-интерфейс пользователя:
    ...
    - [ ] формирование графиков изменения температуры, скорости ветра и статистики направлений ветра за выбранный период;
- [ ] API мобильных клиентов:
    - [ ] список метеостанций;
